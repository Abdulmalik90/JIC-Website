...
initMajors(
  {
    subtitle: "برامج الدبلوم المتوسط في كلية الجبيل الصناعية",
    degreeLabel: "دبلوم متوسط",
  ...
  [
      ...
      semesters: [
        ...
        },
        {
            ...
            courses: [
                ...
                ["Database Concepts", 3, 2, 3, ["Computer Fundamentals"]],
        ...
        },
        {
            ...
            courses: [
                ...
                ["Computer Network II", 3, 2, 3, ["Computer Network I"]],
                ["PC Configuration and Troubleshooting", 2, 0, 4, ["Introduction to Virtualization", "PC Hardware Technology"]],
                ["Network Operating Systems", 3, 2, 3, ["Introduction to Virtualization", "Computer Network I"]],
        ...
        },
        {
            ...
            courses: [
                ...
                ["End-User Support", 3, 2, 3, ["PC Configuration and Troubleshooting"]],
                ["System Administration", 3, 2, 3, ["Network Operating Systems"]],
                ["Computer and Network Security", 3, 2, 3, ["Computer Network II", "Network Operating Systems"]],
                ["COIT Project", 2, 0, 4, ["PC Configuration and Troubleshooting", "Network Operating Systems"]],
            ]
        },
        {
            semester: 5,
        ...
        },
        {
            ...
            courses: [
                ...
                ["Introduction to Artificial Intelligence", 3, 3, 0, []],
    ...
    },
    {
      ...
      nameEn: "Chemical engineering technology",
      category: "science",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
    ...
    {
      name: "تقنية هندسة القوى الكهربائية",
      nameEn: "Electrical power engineering technology",
      category: "industrial",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
    ...
    {
      name: "تقنية هندسة الآلات الدقيقة والتحكم",
      nameEn: "Instrumentation and Control Engineering Technology",
      category: "industrial",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
    ...
    {
      name: "تقنية هندسة التصنيع",
      nameEn: "Manufacturing engineering technology",
      category: "industrial",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
    ...
    {
      name: "تقنية هندسة البوليمرات",
      nameEn: "Polymer Engineering Technology",
      category: "science",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
    ...
    {
      name: "تقنية الكيمياء الصناعية",
      nameEn: "Industrial chemistry technology",
      category: "science",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين وبنات",
    ...
    {
      name: "تقنية هندسة الصيانة الميكانيكية",
      nameEn: "Mechanical maintenance engineering technology",
      category: "industrial",
      degree: "دبلوم متوسط",
      years: 3,
      track: "بنين",
