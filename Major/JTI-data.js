initMajors(
  {
    subtitle: "برامج الدبلوم في معهد الجبيل التقني",
    degreeLabel: "دبلوم",
    institute: "معهد الجبيل التقني"
  },
  [
    {
      name: "مهارة صيانة الآلات الصناعية",
      nameEn: "Industrial Millwright Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
      ...
      semesters: [
        ...
        },
        {
            semester: 2,
            courses: [
                ["Hydraulics and Pneumatics", 2, 1, 3, []],
    ...
    {
      name: "مهارة خراطة وتشكيل المعادن",
      nameEn: "Industrial Machining Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة اللحام الصناعي",
      nameEn: "Industrial welding skill",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة تشغيل الرافعات",
      nameEn: "Crane and Forklift Operation Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة تمديد الأنابيب",
      nameEn: "Industrial Pipefitting Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة الكهرباء الصناعية",
      nameEn: "Industrial Electrical Skill",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارات الآلات الدقيقة والتحكم",
      nameEn: "Industrial Instrumentation and Control Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة إدارة شبكات الحاسب الآلي",
      nameEn: "Network Administration Skills",
      category: "it",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارات تشغيل العمليات",
      nameEn: "Process Operation Skills",
      category: "industrial",
      degree: "الدبلوم",
      years: 2,
      track: "بنين",
    ...
    {
      name: "مهارة الرسم والتصميم بالحاسب الآلي",
      nameEn: "Computer Aided Drafting & Design Skills",
      category: "it",
      degree: "الدبلوم",
      years: 2,
      track: "بنين وبنات",
    ...
    {
      name: "دعم وأمن تقنية المعلومات",
      nameEn: "IT Support and Security",
      category: "it",
      degree: "الدبلوم",
      years: 2,
      track: "بنات",
